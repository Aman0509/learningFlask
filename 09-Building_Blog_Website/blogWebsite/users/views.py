...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user is not None and user.check_password(form.password.data):
            ...
            # Once login verification is done above, then user is redirected to home page
            # or to the page which required login
...
def user_posts(username):
    ...
    # Here 'author' is back reference we have defined in BlogPost model class
    # Using ORM concept to sort the blogs in descending order by date
